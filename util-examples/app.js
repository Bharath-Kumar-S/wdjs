...
const  utl  = require('../utilities/common-utilities.js');
...
utl.excel_getTableRows(__dirname+'/sample.xlsx', 'info', function(results){
  console.log(results);
...
const JSONObject = [{"animals": {name:"cat", name:"dog", name:"dog"}}];

console.log(utl.isContains(JSONObject, 'dog'));
